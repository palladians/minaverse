...
export const env = createEnv({
  client: {
    ...
    NEXT_PUBLIC_MAINNET_EXPLORER_API_URL: z.string().min(1),
    ...
    NEXT_PUBLIC_DEVNET_EXPLORER_API_URL: z.string().min(1),
    ...
    NEXT_PUBLIC_BERKELEY_EXPLORER_API_URL: z.string().min(1),
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_MAINNET_EXPLORER_API_URL: process.env.NEXT_PUBLIC_MAINNET_EXPLORER_API_URL,
    NEXT_PUBLIC_DEVNET_EXPLORER_API_URL: process.env.NEXT_PUBLIC_DEVNET_EXPLORER_API_URL,
    NEXT_PUBLIC_BERKELEY_EXPLORER_API_URL: process.env.NEXT_PUBLIC_BERKELEY_EXPLORER_API_URL
  }
})
